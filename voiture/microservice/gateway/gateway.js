...
app.use(async (req, res, next) => {
  try {
    ...
    if (req.path.startsWith("/service-payment")) {
      req.targetService = services.find((s) => s.name === "service-payment");
      console.log("Service Payment :" + JSON.stringify(req.targetService));
    } else if (req.path.startsWith("/service-voiture")) {
      req.targetService = services.find((s) => s.name === "service-voiture");
      console.log("Service Voiture :" + JSON.stringify(req.targetService));
    }
