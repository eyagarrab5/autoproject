...
const validate = async (req,res,next)=>{
    try{
        ...
        if (err && err.name === 'ValidationError') {
            ...
            return res.status(400).json({ message: 'Plusieurs champs invalides', errors: details })
        }
...
module.exports = { validate, validateVoitureCreate, validateVoitureUpdate, validateEntretienCreate, validateEntretienUpdate }